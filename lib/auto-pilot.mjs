 ...
 */
export async function generateImageWithChatGPT(imagePrompt, aspectRatio = '9:16', hasMascotDu = true, preferredAccount = null) {
  try {
...
export async function executeSingleNode(nodeType, payload = {}, config = null) {
  ...
  switch (nodeType) {
    ...
    case 'chatgpt': {
      ...
      const rawRatio = payload.aspectRatio || cfg.aspectRatio || '9:16';
      const ratio = (rawRatio === '4:5' || rawRatio === '4/5') ? '9:16' : rawRatio;
