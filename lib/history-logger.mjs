  ...
  try {
    ...
    if (!computedChannelName) {
      ...
      const newEntry = {
        ...
        aspectRatio: (aspectRatio === '4:5' || aspectRatio === '4/5' || !aspectRatio) ? '9:16' : aspectRatio,
    ...
    // Bắn cảnh báo tự động về Telegram Bot (Port 3004) nếu gặp lỗi
    if (status === 'failed') {
      try {
        fetch('http://127.0.0.1:3004/alert', {
          method: 'POST',
