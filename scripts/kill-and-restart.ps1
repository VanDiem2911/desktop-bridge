...
# Dung va khoi dong lai 4 Server (Next.js 3000, ChatGPT & FB Personal 3001, FB Groups 3002, Bot 3004)

$servers = @(
    @{ Port = 3000; File = 'server.mjs';       Name = 'Next.js Control Center Dashboard' },
    @{ Port = 3001; File = 'server.mjs';       Name = 'Server 1 (ChatGPT & Facebook Ca Nhan)' },
    @{ Port = 3002; File = 'group-server.mjs'; Name = 'Server 2 (Facebook Groups - Dang bai trong nhom)' },
